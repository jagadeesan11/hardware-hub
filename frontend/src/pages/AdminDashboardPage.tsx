          ...
          <div key={order.id} className="rounded-xl border border-slate-200 bg-white">
            <div className="flex flex-wrap items-start justify-between gap-3 p-4">
              <div className="min-w-0">
                ...
                >
                  Order {order.id.slice(0, 8)} {isOpen ? '▾' : '▸'}
                </button>
    ...
    <div className="space-y-4">
      ...
      >
        <div className="min-w-48 flex-1">
          <label htmlFor="newCategoryName" className="mb-1 block text-sm font-medium text-ink-700">
            New category
          </label>
          <input
            id="newCategoryName"
        ...
        <div>
          <label htmlFor="newCategoryParent" className="mb-1 block text-sm font-medium text-ink-700">
            Parent (optional)
          </label>
          <select
      ...
      <p className="text-xs text-ink-500">
        Categories nest one level deep — pick a parent to create a subcategory, or leave it blank
        for a top-level category like &ldquo;Doors&rdquo; or &ldquo;Paints&rdquo;.
      </p>
